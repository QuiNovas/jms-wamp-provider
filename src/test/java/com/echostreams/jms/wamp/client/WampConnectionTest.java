...
public class WampConnectionTest extends WampConnectionTestSupport {
    ...
    public void testCreateSessionDefaultMode() throws JMSException, IOException {
        WampSession session = (WampSession) connection.createSession();
    ...
    public void testCreateConnectionConsumerOnQueueConnection() throws JMSException {
        QueueConnection queueConnection = createQueueConnectionToMockWampClient();
    ...
    public void testCreateTopicSessionOnTopicConnection() throws JMSException {
        TopicConnection topicConnection = createTopicConnectionToMockWampClient();
