...
public class WampJMSConsumerTest extends WampConnectionTestSupport {
    private static final Logger LOGGER = LoggerFactory.getLogger(WampJMSConsumerTest.class);

    @Test
    public void testGetMessageSelector() throws JMSException {
        WampJMSConsumer consumer = Mockito.mock(WampJMSConsumer.class);
