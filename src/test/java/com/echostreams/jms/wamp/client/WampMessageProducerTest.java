...
public class WampMessageProducerTest extends WampConnectionTestSupport {

    private static final Logger LOGGER = LoggerFactory.getLogger(WampMessageProducerTest.class);
    ...
    public void setUp() throws Exception {
        ...
        session = (WampSession) connection.createSession(false, Session.AUTO_ACKNOWLEDGE);
    }

    @Test(timeout = 10000)
    public void testCreateProducerWithNullDestination() throws Exception {
        MessageProducer producer = new WampMessageProducer();
    ...
    public void testSendWithProducerNull() throws Exception {
        WampDestination dest = new WampTopic("test_topic");
        MessageProducer producer = new WampMessageProducer();
