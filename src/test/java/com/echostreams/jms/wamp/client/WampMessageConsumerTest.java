...
public class WampMessageConsumerTest extends WampConnectionTestSupport {
    private static final Logger LOGGER = LoggerFactory.getLogger(WampMessageConsumerTest.class);

    @Test
    public void testGetMessageSelector() throws JMSException {
        WampMessageConsumer consumer = Mockito.mock(WampMessageConsumer.class);
