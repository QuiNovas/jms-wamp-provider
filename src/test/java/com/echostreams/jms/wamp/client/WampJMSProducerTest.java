...
public class WampJMSProducerTest extends WampConnectionTestSupport {
    ...
    private final Destination JMS_DESTINATION = new WampTopic("test.target.topic:001");
    private final Destination JMS_REPLY_TO = new WampTopic("test.replyto.topic:001");
    ...
    public void testGetPropertyNames() throws JMSException {
        WampJMSProducer producer = new WampJMSProducer();
    ...
    public void testSetPropertyWithNull() {
        WampJMSProducer producer = mock(WampJMSProducer.class);
    ...
    public void testRuntimeExceptionFromSendMessage() throws JMSException {
        WampSession session = mock(WampSession.class);
        Message message = mock(Message.class);

        Mockito.when(session.createTopic("test")).thenReturn(new WampTopic("test"));
