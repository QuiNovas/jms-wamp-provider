...
public class JNDIReferenceFactoryTest {
    ...
    public void testGetObjectInstanceCreatesPulsarConnectionFactory() throws Exception {
        Reference reference = createTestReference(WampConnectionFactory.class.getName(), REMOTE_URI_NAME_PROP, TEST_CONNECTION_URL);
        ...
        assertEquals("Unexpected object type created", WampConnectionFactory.class, connFactory.getClass());
    }

    @Test
    public void testGetObjectInstanceCreatesPulsarQueue() throws Exception {
        Reference reference = createTestReference(WampQueue.class.getName(), DESTINATION_NAME_PROP, TEST_QUEUE_ADDRESS);
    ...
    public void testGetObjectInstanceCreatesPulsarTopic() throws Exception {
        Reference reference = createTestReference(WampTopic.class.getName(), DESTINATION_NAME_PROP, TEST_TOPIC_ADDRESS);
