...
public class WampMessageTest {
    ...
    private static final Logger LOGGER = LoggerFactory.getLogger(WampMessageTest.class);

    private String jmsMessageID;
    private String jmsCorrelationID;
    private WampDestination jmsDestination;
    private WampDestination jmsReplyTo;
    ...
    public void setUp() throws Exception {
        ...
        this.jmsDestination = new WampTopic("test.topic");
        this.jmsReplyTo = new WampTopic("test.replyto.topic:001");
    ...
    public void testClearBody() throws JMSException {
        WampBytesMessage msg;

        msg = new WampBytesMessage();
        msg.clearBody();
...
//--------- Test for getBody method --------------------------------------//
    ...
    public void testToString() throws Exception {
        ...
        msg = new WampMessage();
        assertTrue(msg.toString().startsWith("WampMessage"));
    }
}
