...
public class WampInitialContextFactory implements InitialContextFactory {

    public static final String[] DEFAULT_CONNECTION_FACTORY_NAMES = {
            "ConnectionFactory", "QueueConnectionFactory", "TopicConnectionFactory" };

    public static final String CONNECTION_FACTORY_KEY_PREFIX = "connectionfactory.";
    public static final String QUEUE_KEY_PREFIX = "queue.";
    public static final String TOPIC_KEY_PREFIX = "topic.";
    public static final String CONNECTION_FACTORY_DEFAULT_KEY_PREFIX = "default." + CONNECTION_FACTORY_KEY_PREFIX;
    public static final String CONNECTION_FACTORY_PROPERTY_KEY_PREFIX = "property." + CONNECTION_FACTORY_KEY_PREFIX;

    public WampInitialContextFactory() {
        super();
    }
    ...
    private void createConnectionFactories(Hashtable<Object, Object> environment, Map<String, Object> bindings) throws NamingException {
        ...
        for (Map.Entry<String, String> entry : factories.entrySet()) {
            ...
            WampConnectionFactory factory = null;
            try {
    ...
    protected WampConnectionFactory createConnectionFactory(String name, String uri, Map<String, String> defaults, Hashtable<Object, Object> environment) throws URISyntaxException {
        ...
        if (uri != null && !uri.trim().isEmpty()) {
            props.put(WampConnectionFactory.DEFAULT_WAMP_WEBSOCKET_URL, uri);
        }
     ...
     */
    protected WampConnectionFactory createConnectionFactory(Map<String, String> properties) {
        WampConnectionFactory factory = new WampConnectionFactory();
