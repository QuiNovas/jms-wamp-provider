...
public class PropertyUtils {
    ...
    private static List<Method> findSetterMethod(Class<?> clazz, String name) {
    ...
    private static Object convert(Object value, Class<?> type) throws Exception {
        ...
        if (type.isAssignableFrom(String[].class)) {
            return com.echostreams.jms.wamp.utils.ArrayUtils.convertToStringArray(value);
        }
        ...
        return com.echostreams.jms.wamp.utils.TypeConversionHelper.convert(value, type);
    }
}
