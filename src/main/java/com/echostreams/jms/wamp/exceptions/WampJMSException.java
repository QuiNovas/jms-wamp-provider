...
public class WampJMSException extends JMSException {

    private static final long serialVersionUID = -7153852455484731200L;

    public WampJMSException(String reason, String errorCode) {
        super(reason, errorCode);
    }

    public WampJMSException(String message, String errorCode, Throwable linkedException) {
