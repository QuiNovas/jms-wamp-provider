...
import com.echostreams.jms.wamp.config.JmsHeaderKeys;
...
public class WampMessage implements Message, Serializable {
    ...
    public void setJMSReplyTo(Destination replyTo) throws JMSException {
        headers.put(JmsHeaderKeys.JMSReplyTo, (WampDestination) replyTo);
    }
    ...
    public void setJMSDestination(Destination destination) throws JMSException {
        headers.put(JmsHeaderKeys.JMSDestination, (WampDestination) destination);
    }
