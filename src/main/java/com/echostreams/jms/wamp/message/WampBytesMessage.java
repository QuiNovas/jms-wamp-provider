...
public class WampBytesMessage extends WampMessage implements BytesMessage {
    ...
    public WampBytesMessage() throws JMSException {
        super();
        headers = new HashMap<>();
        headers.put(PROPERTIES, new HashMap<String, Serializable>());
        setJMSType(JmsWampConstants.BYTES_MESSAGE);
        setToWriteOnlyMode();
    }
