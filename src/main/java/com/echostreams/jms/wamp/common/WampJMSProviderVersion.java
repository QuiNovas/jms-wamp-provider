...
/**
 * WampJMSProviderVersion
 */
public class WampJMSProviderVersion {
    private static final Logger LOGGER = LoggerFactory.getLogger(WampJMSProviderVersion.class);
    ...
    static {
        try {
            InputStream in = WampJMSProviderVersion.class.getResourceAsStream("/WampJMSProvider.version");
            if (in != null) {
